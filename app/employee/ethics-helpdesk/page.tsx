...
export default function EthicshelpdeskPage() {
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Ethics Helpdesk</h1>
        <p className="text-gray-600 mt-2">Ethics Helpdesk management</p>
      </div>
