...
const TopHeader: React.FC<TopHeaderProps> = ({ userName, userRole, companyName, onCompanyChange }) => {
...
const CompanySwitcherModal: React.FC<CompanySwitcherModalProps> = ({ currentCompany, onClose, onSwitch }) => {
