  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 md:mb-6">
        <h2 className="text-xl md:text-3xl font-bold text-gray-800">Company Announcements</h2>
        <button
          onClick={() => setShowModal(true)}
          className="w-full sm:w-auto bg-[#f7941e] text-white px-5 py-2 rounded-lg hover:bg-orange-600 transition text-sm md:text-base"
        >
          + New Announcement
        </button>
      </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-4 md:p-6 rounded-lg w-full max-w-md shadow-lg">
            <h3 className="text-lg md:text-xl font-bold mb-4">Create Announcement</h3>
            <input
              type="text"
              placeholder="Title"
